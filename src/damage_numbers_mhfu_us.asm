...
index equ 0x08920890 ;Done
pointer equ 0x089208A0 ;Done

.createfile "./bin/DAMAGE_NUMBERS_US.bin", 0x089205E0 ;Done
    move t6, t0
...
.createfile "./bin/COPY_MATRIX_US.bin", 0x08920A90 ;Done
    vmmov.q m700, m100
    jr     ra
.close

.createfile "./bin/DAMAGE_DRAWING_US.bin", 0x089208E0 ;Done
    ...
    li      t0, 0x09C448DC ;Done
    li      t1, 0x24030008 ;Done
    sw      t1, 0(t0)

    li      t0, 0x09AC7AD4 ;Done
    li      t1, 0x0A248178 ;Done
    sw      t1, 0(t0)
